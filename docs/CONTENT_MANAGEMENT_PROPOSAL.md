...
The client should be able to change anything they _should_ change and nothing they shouldn't.
...
| Roles                  | _Editor_ drafts, _Administrator_ publishes — the firm decides who signs off on public claims                    |
...
**On a phone:** open a bookmark, log in with Google or email, tap _Team → Gillian Acheampong_, correct the surname, tap _Publish_. Live in about five seconds.

**Adding a team member:** tap _Team → +_, fill in name, title, and type, upload a photograph straight from the camera roll, drag the hotspot over the face, paste the bio, publish. The profile page, the attorneys listing, and the sitemap all update automatically.

**Adding an insight:** tap _Insights → +_, choose the section, write the article, upload an image, publish.

**Changing the phone number:** _Site Settings → Phone_. One field. It updates in all nine places at once.
